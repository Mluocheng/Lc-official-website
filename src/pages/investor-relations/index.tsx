...
function Governance() {
  return (
    <div>
      ...
      <p className="text-gray-700">集团（「」或「本公司」），连同其附属公司及为会计目的而综合入账的公司合称为「本集团」）为中国领先的中小企业云端商业及营销解决方案提供商。本公司的股份将在香港联交所主板上市。</p>
      <p className="text-gray-700">董事声明本集团须按照诚信的原则及遵循适合的管治方法经营业务。</p>
    </div>
  );
}
