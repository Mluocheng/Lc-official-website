...
const saasProducts = [
  {
    icon: '🛒',
    title: '微商城',
    desc: '微商城是面向电商行业商家的全渠道全场景私域开店解决方案。商家可一键开通微信、支付宝、百度、小红书等多渠道店铺，并实现统一后台管理和经营，快速实现流量沉淀、转化变现、会员沉淀、裂变增长的全流程运营，以私域经营带动品牌可持续增长。',
  },
  {
    icon: '💬',
    title: '企微助手',
    desc: '企微助手是基于企业微信的全链路客户运营增长解决方案，帮助企业沉淀私域流量池，助力企业通过数字化运营工具低成本实现获客和客户运营， 加速客户变现转化，促进持续增长。',
  },
  {
    icon: '🔄',
    title: 'WAI',
    desc: 'AI产品WAI通过先进的AIGC技术，覆盖品牌全链路场景，赋能商家进行高效获客、图文创作、营销推广、客户陪伴、客户洞察等能力，构建线上私域经营，助力商家智慧经营降本增效，驱动企业新增长力。',
  },
  {
    icon: '▶️',
    title: '视频号助手',
    desc: '视频号助手，聚合运营、数据监控、私域运营、转化成交、直播带货等一站式解决方案，助力商家实现公私域一体化经营。',
  },
];
